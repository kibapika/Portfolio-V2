    ...
    <div>
      {desktopScreen ? (
        <div className="text-[1.1rem]">
          <button className="border-2 rounded-md px-3 py-1.5 ml-5 flex items-center cursor-point hover:bg-[#FCA311] hover:border-[#FCA311] hover:bg-opacity-20 hover:duration-300">
